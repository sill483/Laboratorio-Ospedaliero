...
Miglioramenti o funzioni da aggiungere in futuro: -Migliorare la ricerca con una finestra simile a quella di Google, con la 'finestra suggerita in tempo reale' quando cerchi qualcosa; -Cancellazione con un solo clic; -Aggiunta di grafica di qualità superiore; -Implementazione Database relazionale (come SQLite).
